...
#ifndef MATRIXMULTIPLICATION_MATRIXBDATA_H
#define MATRIXMULTIPLICATION_MATRIXBDATA_H
...
class MatrixBdata {
public:
    MatrixBdata(const std::shared_ptr<MatrixRequestData> &request,
                    Type &matrixData,
                    size_t matrixWidth,
                    size_t matrixHeight,
...
#endif //MATRIXMULTIPLICATION_MATRIXBDATA_H
